 ...
 */
#ifdef MBEDTLS_SSL_PROTO_TLS1_3_SUPPORTS
#define MBEDTLS_SSL_PROTO_TLS1_3
#endif /* MBEDTLS_SSL_PROTO_TLS1_3_SUPPORTS */
...
#define MBEDTLS_PLATFORM_TIME_MACRO            rt_mbedtls_time /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
...
#include <sys/time.h>
extern time_t rt_mbedtls_time(time_t *t);
